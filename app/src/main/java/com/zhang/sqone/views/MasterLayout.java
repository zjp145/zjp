...
public class MasterLayout extends FrameLayout implements OnClickListener {
    ...
    public int flg_frmwrk_mode = 2;
    boolean first_click = false;
    //自己添加初始化显示
    private Bitmap zhang_icon_bmp;
    private Path tick2;
    private Paint fill_color2;
    ...
    private void setpaint() {
        ...
        fill_color.setColor(Color.rgb(176, 176, 176)); // Edit this to change the
        // circle fill color
        fill_color.setStyle(Paint.Style.FILL_AND_STROKE);
        fill_color.setAntiAlias(true);

        fill_color2 = new Paint(Paint.ANTI_ALIAS_FLAG);
        fill_color2.setColor(Color.rgb(176, 176, 176)); // Edit this to change the
        // circle fill color
        fill_color2.setStrokeWidth(4);
        fill_color2.setStyle(Paint.Style.STROKE);
        fill_color2.setAntiAlias(true);
    ...
    private void displayMetrics() {
        ...
        Log.i("tupian", "width:" + width + "height" + height);
        float scarea = width * height;
        pix = (int) Math.sqrt(scarea * 0.0057);
    ...
    private void iconCreate() {
        ...
        tick2 = new Path();
        tick2.moveTo(pix * 30 / 100, pix * 60 / 100);
        tick2.lineTo(pix * 50 / 100, pix * 750 / 1000);
        tick2.lineTo(pix * 70 / 100, pix * 600 / 1000);
        tick2.moveTo(pix * 50 / 100, pix * 28 / 100);
        tick2.lineTo(pix * 50 / 100, pix * 750 / 1000);
    ...
    public void init() {
        ...
        zhang_icon_bmp = Bitmap.createBitmap(pix, pix, conf); // Bitmap to draw
        // first icon(
        // Default -
        // Play )
        ...
        Canvas zhang_icon_canvas = new Canvas(zhang_icon_bmp);
        ...
        zhang_icon_canvas.drawPath(tick2, fill_color2);
        ...
        buttonimage.setImageBitmap(zhang_icon_bmp);
        flg_frmwrk_mode = 1;
