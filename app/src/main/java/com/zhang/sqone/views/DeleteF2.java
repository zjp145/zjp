 ...
 */
public abstract class DeleteF2 {
     ...
     */
    // 删除提示框
    public DeleteF2 deleteDialog(Context context, String tetle,
                                String btDetermine, String btDismiss) {

        final Dialog dialog = new AlertDialog.Builder(context).create();
        dialog.show();
        dialog.getWindow().setContentView(R.layout.dolig_3);
        ...
        TextView tv_tetle = (TextView) dialog.findViewById(R.id.tv_tetle3);
