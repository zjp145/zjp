...
public class HYCLXQActivity extends BaseActivity {
    ...
    public void regRequest() {
        ...
        final Meetingroom.ReqMeetingRoom reqDocument = Meetingroom.ReqMeetingRoom.newBuilder().setSid(User.sid).setMmd(builder).setAc("HYCLXQ").build();
        new UniversalHttp() {
            @Override
...
//                            Log.i("zhang", "有文件");
                                ...
                                XiaZaiUtil xiaZaiUtil = new XiaZaiUtil(holder.<ImageButton>getView(R.id.xiazai_iamge_button), HYCLXQActivity.this, ceshi.getUrl(), holder.<MasterLayout>getView(R.id.xiazai_zx), holder.<TextView>getView(R.id.xiazai_sudu),ceshi.getName());
//                        Log.i("zhang", ceshi.getFt());
                        ...
                        Toast.makeText(HYCLXQActivity.this, index.getMsg(), Toast.LENGTH_SHORT).show();
                    }

                }
            }
        }.protocolBuffer(HYCLXQActivity.this, Globals.HYAP_URI, null);
